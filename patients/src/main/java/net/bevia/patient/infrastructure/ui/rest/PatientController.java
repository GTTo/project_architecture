...
import net.bevia.patient.app.services.PatientService;
import net.bevia.patient.domain.entities.Patient;
import net.bevia.patient.domain.exceptions.PatientException;
import net.bevia.patient.domain.models.PatientHistory;
import net.bevia.patient.infrastructure.clients.PatientHistoryClient;
